...
export default function HeroSection({ page }: HeroSectionProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-amber-600/10 rounded-full blur-3xl" /> {/* Changed: emerald-600 to amber-600 */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight mb-6">
          ...
          <br />
          <span className="bg-gradient-to-r from-electric-400 via-amber-400 to-electric-500 bg-clip-text text-transparent"> {/* Changed: emerald-400 to amber-400 */}
            {secondLine}
          </span>
        </h1>
